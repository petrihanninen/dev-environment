...
function activate(context) {
    ...
    const settings = vscode.workspace.getConfiguration().get('less');
    const serverOptions = {
        run: {
            module: serverModule,
    ...
    const client = new vscode_languageclient_1.LanguageClient('less-intellisense', 'Less IntelliSense', serverOptions, clientOptions);
    const disposable = [];
